...
import fr.front.api.rentalCarsdto.CarDto;
...
@Path("/rental-cars")
public class FrontApiRessourceCars {
    ...
    public Response updatePartialRentalProperty(@PathParam("id") String id, @Valid CarDto carDto) {
        try {
    ...
    @Path("/{id}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response updateRentalProperty(@PathParam("id") String id, @Valid CarDto carDto) {
        try {
    ...
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    public Response createRentalProperty(@Valid CarDto carDto) {
        try {
    ...
    private String toJson(CarDto carsDto) {
        try {
            ...
            return mapper.writeValueAsString(carsDto);
        } catch (Exception e) {
